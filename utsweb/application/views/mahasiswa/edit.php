		    ...
		    <?php endif ?>
				<form action="" method="post">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="nama" name="nama" value="<?= $mahasiswa['nama'];?>" ><?= form_error('nama'); ?>
					</div>
					<div class="form-group">
					...
					<button  type="edit" name="submit" name="edit"class="btn btn-primary float-right">Edit</button>
				</form>
			</div>
		</div>
	</div>
